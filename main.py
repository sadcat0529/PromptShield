    ...
    for banned in BANNED_WORDS:
        if banned in text:
            raise HTTPException(
                ...
                detail=f"메시지에 금지된 단어가 포함되어 있습니다: {banned}"
            )
#여기까지
...
async def chat_completion(
    ...
    user_message = None
    global Filtering_enabled
    # 'Filtering_enabled' 값을 form_data에서 받아옵니다.
    #Filtering_enabled = form_data.get("FilteringEnabled", False)
